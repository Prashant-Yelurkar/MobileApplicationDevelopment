...
public class Absolute_Layout extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        java.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Intent i = new Intent(Absolute_Layout.this, DisplayCode.class);
                i.putExtra("doc_name", "absolute_java");
                startActivity(i);
            }
        });
        xml.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Intent i = new Intent(Absolute_Layout.this, DisplayCode.class);
                i.putExtra("doc_name", "absolute_xml");
                startActivity(i);
            }
        });
        doc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                i.putExtra("doc_name", "absoluteLayout");
                startActivity(i);
            }
        });
    }
